package com.mtm.widget.datepicker;
...
public class MonthDateView extends View {
	...
	private int mSelectBGColor = Color.parseColor("#C8C8C8");
//	private int mSelectBGColor = Color.parseColor("#1FC2F3");
	 ...
	 *            显示周
	 */
	public void setTextView(TextView tv_date, TextView tv_week, int currYear, int currMonth, int currDay) {
		mCurrYear = currYear;
		mCurrMonth = currMonth;
		mCurrDay = currDay;
		setSelectYearMonth(mCurrYear, mCurrMonth, mCurrDay);
		this.tv_date = tv_date;
		this.tv_week = tv_week;
